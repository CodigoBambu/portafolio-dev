    ...
    const fragmentShaderSrc = `
            ...
            void main() {
                ...
                if (sum >= 0.99) {
                    ...
                    vec3 lightGray = vec3(0.5, 0.5, 0.5); 
                    vec3 white = vec3(1.0, 1.0, 1.0); 

                    vec3 color = mix(black, darkGray, max(0.0, (sum - 0.99) * 50.0));
                    color = mix(color, lightGray, max(0.0, (sum - 0.99) * 100.0));
                    color = mix(color, white, max(0.0, (sum - 0.99) * 150.0));
